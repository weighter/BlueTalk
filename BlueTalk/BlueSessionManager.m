...
@property (strong, nonatomic) MCNearbyServiceBrowser *browser; // 搜索蓝牙
...
#pragma mark 下面是MCAdvertiserAssistant的两个代
...
#pragma mark 自带的MCBrowserViewController
