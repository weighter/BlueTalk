...
@interface UToConversationViewController () <UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate> {
...
- (void)createUI {
    ...
    self.sendBackView.backgroundColor = [UIColor lightGrayColor];
...
- (void)makeBlueData {
    ...
    [get_singleton_for_class(UToBlueSessionManager) receiveDataOnMainQueue:YES block:^(NSData *data, MCPeerID *peer) {
        ...
        [strongSelf.dataArray addObject:chatItem];
        // 加到数组里面
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = chatItem.displayName;
    cell.detailTextLabel.text = chatItem.content;
    return cell;
}
